"""
Django settings for MPSCamera project.
...
import mongoengine
from monitor.utils import init_mongo_connection
...
WSGI_APPLICATION = 'MPSCamera.wsgi.application'
